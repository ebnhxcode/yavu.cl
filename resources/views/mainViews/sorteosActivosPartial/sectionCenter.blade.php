<div class="list-group-item">
  <a href="/main/sorteos/finalizados" class="btn btn-default btn-xs text-danger">VER LISTA DE SORTEOS FINALIZADOS</a>
</div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-11 col-lg-11">
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                ...
                <div class="">
                  <a style="padding-left: 5px;" href="/main/sorteo/{!! $sorteo->id !!}"><span>{!!$sorteo->descripcion!!}</span><br></a>
                </div>

                <div class=" softText-descriptions-middle">
                  <a style="padding-left: 5px;" href="/main/sorteo/{!! $sorteo->id !!}">
                    <small> Este sorteo se realizara el d&iacute;a
                ...
                <a href="/usuarios/create">
                  <button class="btn btn-success btn-sm UsarTicket" value="{!! $sorteo->id !!}" type="button"   style="" data-dismiss="modal">PARTICIPAR</button>
                  <br>
                  <small><span class="softText-descriptions-middle">Para participar debes estar registrado</span></small>
                </a><!-- /div .semi-amplio -->
