...
<div class="jumbotron">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="row">
          <div id="seeker" class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              ...
              <div class="">
                ...
                @elseif(Auth::user()->check())
                  ...
                  <div class="input-group input-group-sm">
                    ...
                    {!!Form::text('nombre',null,['class' => 'form-control buscar input-md', 'placeholder' => 'Buscar empresas','id'=>'empresathumb', 'aria-describedby' => 'sizing-addon1'])!!}
          ...
          <div id="filters" class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            {!!Form::select('ciudad',
                  ...
                  $selected = null, ['class' => '', 'required' => 'required', 'id' => 'CityOnly'])!!}
