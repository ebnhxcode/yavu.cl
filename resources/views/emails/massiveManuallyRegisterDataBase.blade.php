...
<html>
  <head>
    ...
    <link rel="stylesheet" href="http://yavu.cl/css/bootstrap.css">
      ...
      <table width="100%">
        <tr align="center">
          <td colspan="2" width="100%" style="background-color: whitesmoke; border-radius: 10px 10px 10px 10px; ">
            ...
            <img width="100" src="http://yavu.cl/img/yavu019.png" alt="">
            <br>
            ...
            <div style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:14px; line-height:36px">
              ...
              <br><br>
              <a style="padding: 15px 15px 15px 15px; border: solid 1px #77e679; border-radius: 4px 4px 4px 4px; background-color: #4cae4c; color:#88ff8a; font-size: 3em;" href="http://yavu.cl/">¿¡De qu&eacute; se trata!?.. <small>m&aacute;s info..</small></a>
              <br><br>
        ...
        <tr align="center">
          <td width="50%" style="background-color: whitesmoke; border-radius: 10px 10px 10px 10px; ">
            ...
            <img width="200" src="http://yavu.cl/img/newGraphics/icofinal_publicaciones.png" alt="">
          </td>
          <td width="50%" style="background-color: whitesmoke; border-radius: 10px 10px 10px 10px; ">
            <b style="font-size: 1.5em;">¡Encuentra sorteos y participa gratis!</b><br>
            <img width="200" src="http://yavu.cl/img/newGraphics/icofinal_sorteos_premios.png" alt="">
            <br>
          </td>
        </tr>
