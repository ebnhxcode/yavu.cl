        ...
        <tr align="center">
          <td colspan="2" width="100%" style="background-color: whitesmoke; border-radius: 10px 10px 10px 10px; ">
            ...
            <div style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:14px; line-height:36px">
              ...
              <br><br>
              <a style="padding: 15px 15px 15px 15px; border: solid 1px #77e679; border-radius: 4px 4px 4px 4px; background-color: #4cae4c; color:#88ff8a; font-size: 3em;" href="http://yavu.cl/">De que se trata</a>
              <br><br>
