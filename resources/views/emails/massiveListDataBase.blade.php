...
<html>
  <head>
    ...
    <div style="background-color: #5cb85c;" align="center">
      ...
      <a style="padding: 10px 10px 10px 10px; border: solid 1px #77e679; border-radius: 4px 4px 4px 4px; background-color: #4cae4c; color:#88ff8a;" href="http://yavu.cl/yavucoins">¡Conócenos!</a>
