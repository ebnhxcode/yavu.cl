...
<body>
<div>
<img src="http://yavu.cl/img/yavu005.png" width="120" height="30" border="0" alt=""/>
...
<br>
<p><strong>Para validar tu cuenta haz click en el enlace de validación: </strong><a href="http://yavu.cl/verificarusuario/{!! $codigo !!}"> Abrir </a>  </p><br>
...
<div>
	<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    ...
	    <td width="14%" align="center"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><a href= "http://yavu.cl/contacto" style="color:#010203; text-decoration:none"><strong>UNSUBSCRIBE </strong></a></font></td>
