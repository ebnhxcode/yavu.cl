...
<body>
<div>
<img src="http://localhost:8000/img/yavu005.png" width="120" height="30" border="0" alt=""/>
...
<div>
	<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    ...
	    <td width="14%" align="center"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><a href= "http://localhost:8000/contacto" style="color:#010203; text-decoration:none"><strong>UNSUBSCRIBE </strong></a></font></td>
