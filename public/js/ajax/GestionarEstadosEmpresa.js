...
/*SELECTORES*/
	...
	$("#publicar").click(function(e){
		...
		if (document.getElementById("status").value !== "") {
			...
			var token = $("#token").val();
			var route = "http_//yavu.cl/estadoempresa";
			$.ajax({
				url: route,
...
/*FUNCIONES Y PROCEDIMIENTOS*/
	function ActualizarEstados(){
		...
		$("#Estados").value ="";
		var route = "http_//yavu.cl/estadosempresa";
		var user_id = $("#user_id");
		var Contador = 0;
					...
					"<div id='status' class='list-group'>"
						+"<div class='list-group-item'>"
							+"<h4><a href='/profile' style='color:#3C5B28;'>"
								+"<img class='media-object' src='http_//yavu.cl/images/user.png' data-holder-rendered='true' style='width: 32px; height: 32px;'/>"
  ...
  function ContarInteracciones(status_id){
	...
	function ContarEstados(){
		...
		var route = "http_//yavu.cl/contarestados";
		var user_id = $("#user_id");
		var Contador = 0;
		$.get(route, function(res){
	...
	function CargarEstados(){
		...
		var route = "http_//yavu.cl/estadosempresa/"+Global_idUltimaPublicacion+"/"+empresa;
		var user_id = $("#user_id");
