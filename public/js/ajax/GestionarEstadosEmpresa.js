...
/*SELECTORES*/
	...
	$("#publicar").click(function(e){
		...
		if (document.getElementById("status").value !== "") {
			...
			var token = $("#token").val();
			var route = "http://192.168.1.42/estadoempresa";
			$.ajax({
				url: route,
...
/*FUNCIONES Y PROCEDIMIENTOS*/
	function ActualizarEstados(){
		...
		$("#Estados").value ="";
		var route = "http://192.168.1.42/estadosempresa";
		var user_id = $("#user_id");
		var Contador = 0;
					...
					"<div id='status' class='list-group'>"
						+"<div class='list-group-item'>"
							+"<h4><a href='/profile' style='color:#3C5B28;'>"
								+"<img class='media-object' src='http://192.168.1.42/images/user.png' data-holder-rendered='true' style='width: 32px; height: 32px;'/>"
	...
	function ContarEstados(){
		...
		var route = "http://192.168.1.42/contarestados";
		var user_id = $("#user_id");
		var Contador = 0;
		$.get(route, function(res){
	...
	function CargarEstados(){
		...
		var route = "http://192.168.1.42/estadosempresa/"+Global_idUltimaPublicacion+"/"+empresa;
		var user_id = $("#user_id").val();
	...
	function Interactuar(valor){
		...
		var user_id = $("#user_id").val();
		var token = $("#token").val();
		var route = "http://192.168.1.42/interactuar";
		$.ajax({
			url: route,
			headers: {'X-CSRF-TOKEN': token},
			type: 'POST',
	...
	function ContarInteracciones(status_id){
		status_id = status_id;
		var route = "http://192.168.1.42/contarinteracciones/"+status_id;
		var user_id = $("#user_id").val();
		var Contador = 0;
		$.get(route, function(res){
			$(res).each(function(key,value){
