...
/*FUNCIONES Y PROCEDIMIENTOS*/
	function CargarDetallesSorteo(sorteo_id){
		var route = "http_//yavu.cl/cargardetallessorteo/"+sorteo_id;
		$.ajax({
			url: route,
			type: 'GET',
			dataType: 'json',
	...
	function ContarNotificaciones(){
		...
		$.ajax({
			url: "http_//yavu.cl/cargarpops/"+$("#idUltimaNotificacion").val()+"/"+user_id+"/novistas",
			type: 'GET',
			dataType: 'json',
			cache: false,
			async: true,
	...
	function MostrarGanador(Ganador){
		...
		var route = "http_//yavu.cl/mostrarganador/"+Ganador;
		$.ajax({
			url: route,
			type: 'GET',
			dataType: 'json',
	...
	function CanjearTicket(){
		$('#myModal').modal('hide');
		var user_id = $("#user_id").val();
		var route = "http_//yavu.cl/canjearticket/"+user_id;
		$.ajax({
			url: route,
	...
	function ContarTicketsEnSorteos(){
		...
		$(".TicketsEnSorteo").each(function(){
			...
			var route = "http_//yavu.cl/contarticketsensorteo/"+$(this).attr('id');
			$.ajax({
				url: route,
				type: 'GET',
				dataType: 'json',
	...
	function UsarTicket(sorteo_id){
		$('#myModal').modal('hide');
		var user_id = $("#user_id").val();	
		var route = "http_//yavu.cl/usarticket/"+user_id+"/"+sorteo_id;
		$.ajax({
			url: route,
			headers: {'X-CSRF-TOKEN': token},
			type: 'GET',
	...
	function RegistrarParticipanteGanador(Ganador){
		var route = "http_//yavu.cl/registrarganadorsorteo/"+Ganador;
		$.ajax({
			url: route,
			type: 'GET',
			dataType: 'json',
	...
	function VerificarTickets(){
		var user_id = $("#user_id").val();
		var route = "http_//yavu.cl/verificartickets/"+user_id;
	...
	function ContarCoins(){
		var route = "http_//yavu.cl/contarcoins";
		var user_id = $("#user_id");
		$.get(route, function(res){
			$(".CantidadCoins").text("");
	...
	function ContarTickets(){
		var route = "http_//yavu.cl/contartickets";
		var user_id = $("#user_id");
		$.get(route, function(res){
